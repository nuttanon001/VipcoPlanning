...
namespace VipcoPlanning.Controllers
{
    ...
    [ApiController]
    public class GenericPlanningController<Entity> : ControllerBase where Entity : class
    {
        public IRepositoryPlanning<Entity> repository;
