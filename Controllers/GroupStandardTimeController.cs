...
namespace VipcoPlanning.Controllers
{
    ...
    [ApiController]
    public class GroupStandardTimeController : GenericPlanningController<GroupStandardTime>
    {
        public GroupStandardTimeController(IRepositoryPlanning<GroupStandardTime> repo,
          IMapper mapper) :
          base(repo, mapper)
        { }

        // POST: api/GroupStandardTime/GetScroll
        [HttpPost("GetScroll")]
        public async Task<IActionResult> GetScroll([FromBody] ScrollViewModel Scroll)
        {
            ...
            var predicate = PredicateBuilder.False<GroupStandardTime>();
            ...
            // Order by
            Func<IQueryable<GroupStandardTime>, IOrderedQueryable<GroupStandardTime>> order;
            // Order
            ...
            return new JsonResult(new ScrollDataViewModel<GroupStandardTime>(Scroll, QueryData.ToList()), this.DefaultJsonSettings);
        }
    }
}
