...
namespace VipcoPlanning.Models.Machines
{
    public partial class MachineContext : DbContext
    {
        ...
        public virtual DbSet<WorkGroupHasWorkShop> WorkGroupHasWorkShop { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WorkGroupHasWorkShop>(entity =>
            {
                entity.HasIndex(e => e.GroupMis);
                ...
                entity.HasOne(d => d.GroupMisNavigation)
                    .WithMany(p => p.WorkGroupHasWorkShop)
                    .HasForeignKey(d => d.GroupMis);
            ...
            modelBuilder.Entity<WorkShop>(entity =>
            {
                ...
                entity.Property(e => e.WorkShopName).HasMaxLength(200);
            });
        }
    }
}
